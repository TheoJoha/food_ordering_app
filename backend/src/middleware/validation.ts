...
export const validateMyRestaurantRequest = [
    ...
    body("deliveryPrice").isFloat({min: 0}).withMessage("Delivery price must be a pos number"),
    ...
    body("menuItems.*.price").isFloat({min: 0}).withMessage("Menu item price is required and must be a pos number"),
    handleValidationErrors,
]